...
fnames = ['population1_highSpinPrecessing_highmass', 'population2_mediumSpin_highmass', 'population3_lowSpinAligned_highmass']
...
for fname in fnames:
    ...
    while n_det<target:
        ...
        if fname=='population1_highSpinPrecessing_highmass': 
        ...
        elif fname=='population2_mediumSpin_highmass': 
            # POP 2: MediumSpin
        ...
        elif fname=='population3_lowSpinAligned_highmass':
