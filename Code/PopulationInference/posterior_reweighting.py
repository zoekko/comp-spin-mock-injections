...
pop = 'pop1'
num_injections = '70'
model = 'betaPlusGaussian' # either betaPlusGaussian or betaPlusDoubleGaussian # OLD: betaPlusGaussian

"""
Function to do posterior reweighting for beta plus Gaussain model 
...
if __name__=="__main__":
    ...
    # Load population parameter PE samps
    with open(f'/home/simona.miller/comp-spin-mock-injections/Data/PopulationInferenceOutput/{model}/{model}_{pop}_{num_injections}events_temp.json', 'r') as f:
        hyperPEDict = json.load(f)
