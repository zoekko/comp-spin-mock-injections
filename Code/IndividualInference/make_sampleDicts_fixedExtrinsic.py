...
"""
Prep for calculations of z_prior and dVc_dz
"""
...
for pop in pop_names: 
    ...
    for event in pop_injlist: 
        ...
        job_name = "job_{0:05d}_fixedExtrinsic_result.json".format(int(event))
    ...
    #output_fname = f'../../Data/PopulationInferenceInput/sampleDict_{pop}_fixedExtrinsic.json'
    output_fname = f'../../Data/PopulationInferenceInput/sampleDict_{pop}_fixedExtrinsic_newbilby.json'
